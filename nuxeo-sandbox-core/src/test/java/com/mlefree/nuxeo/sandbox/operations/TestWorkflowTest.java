...
public class TestWorkflowTest {
    ...
    public void shouldCallTheOperation() throws OperationException {
        ...
        DocumentModel doc = (DocumentModel) automationService.run(ctx, WorkflowTest.ID);
    ...
    public void shouldCallWithParameters() throws OperationException {
        ...
        DocumentModel doc = (DocumentModel) automationService.run(ctx, WorkflowTest.ID, params);
